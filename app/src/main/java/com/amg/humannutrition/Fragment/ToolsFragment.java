...
import com.amg.humannutrition.Activity.ActivityRecognitionActivity;
import com.amg.humannutrition.Activity.BmiTableActivity;
...
public class ToolsFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        Button bmiTableButton=view.findViewById(R.id.bmiTableButton);
        bmiTableButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view){
                Intent intent = new Intent(view.getContext(), BmiTableActivity.class);
                startActivity(intent);
            }
        });
        Button activityRecognitionButton =view.findViewById(R.id.activityRecognitionButton);
        activityRecognitionButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view){
                Intent intent = new Intent(view.getContext(), ActivityRecognitionActivity.class);
                startActivity(intent);
            }
        });
